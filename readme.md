...
В третьем цикле будут созданы все три экземпляра *accum*, затем будут выполнена работа с ними.

Глубина зависимостей *accum* на один уровень глубже, чем у *DerivedA*, поэтому свою работу аккумуляторы выполнят одним циклом позже, что и демонстрирует вывод программы.
