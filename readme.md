# <a name="top"> Реализация контейнера внедрения зависимостей на JavaScript
...
+ [Шаблон определения модулей Dependency Injection](#di)
+ [Контейнер внедрения зависимостей](#dic)
+ [Реализация синхронного DI-контейнера](#dic-sync)

## <a name="di"> Шаблон определения модулей Dependency Injection
...
## <a name="dic"> Контейнер внедрения зависимостей
...
## <a name="dic-sync"> Реализация синхронного DI-контейнера
